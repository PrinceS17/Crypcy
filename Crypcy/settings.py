"""
Django settings for Crypcy project.
...
SECRET_KEY = '=-3=5e_l9l!qcz(08t!a*oyghe09enir_3^q(ch@9+9b_-99u='
...
WSGI_APPLICATION = 'Crypcy.wsgi.application'
