# Generated by Django 2.1.1 on 2019-03-27 20:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crypto_currency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='maker.CryptoCurrency')),
            ],
        ),
        migrations.CreateModel(
            name='RelatedNews',
        ...
        migrations.AddField(
            model_name='metric',
            name='timeslot',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='maker.Timeslot'),
        ),
        migrations.AddField(
            model_name='log',
            name='related_news',
