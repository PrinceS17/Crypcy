...
urlpatterns = [
    ...
    re_path('^get/(?P<name>.+)/$', views.get_currency, name='gets'),
    re_path('^search-coin/(?P<name>.+)/$', views.get_best_currency, name='interesting1'),
    re_path('^search-news/(?P<word>.+)/$', views.get_news, name='interesting2'),
